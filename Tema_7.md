...
### Результат.
![результат](./pic/L6.1.png)
![результат](./pic/L6.2.png)
...
### Результат.
![результат](./pic/L7.1.png)
![результат](./pic/L7.2.png)
...
## Выводы
1. Данная программа находит длиннейшее слово в файле
